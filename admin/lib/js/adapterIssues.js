    ...
    async function getIssues() {
        socket.emit("sendToHost", hosts[0], "getInstalled", null, function (_installed) {
            ...
            if (adapters && typeof adapters === "object") {
                    ...
                    if (key !== "hosts") {
                        ...
                        if (adapter && adapter.readme) {
                            ...
                            $item
                                .find(".titleLink")
                                .text(adapter.title)
                                .attr("href", "https://github.com/" + full_name + "/issues")
                            ...
                            button +=
                                "<button type='button' data-adapter='" +
                                adapter.title +
                                ": " +
                                adapter.version +
                                "' data-href='https://api.github.com/repos/" +
                                full_name +
                                "/issues' class='btn btn-primary create-issue-adapter-button" +
                                (adapterConfig.github_token ? "" : " disabled") +
                                "'>";
                ...
                if (sessionStorage.getItem("ioBroker.infos.stargazers")) {
                    stargazers = JSON.parse(sessionStorage.getItem("ioBroker.infos.stargazers"));
