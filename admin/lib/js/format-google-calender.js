        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            window.formatGoogleCalendar = (function () {
                ...
                var _init = function _init(settings) {
                    ...
                    if (sessionStorage.getItem("ioBroker.infos.events")) {
                        var data = JSON.parse(sessionStorage.getItem("ioBroker.infos.events"));
                        ...
                        request.onload = function () {
                            if (request.status >= 200 && request.status < 400) {
                                sessionStorage.setItem("ioBroker.infos.events", request.responseText);
                ...
                var formatDateSameDay = function formatDateSameDay(
                    ...
                    if (config.sameDayTimes && !moreDaysEvent && !isAllDayEvent) {
                        formattedTime =
                            " " + _("from") + " " + getFormattedTime(dateStart) + " - " + getFormattedTime(dateEnd);
                    }
