...
vis.binds.infos = {
    ...
    createMessage: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds.infos.createMessage(widgetID, view, data, style);
            }, 100);
        }
    ...
    createCalendar: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds.infos.createCalendar(widgetID, view, data, style);
            }, 100);
        }
